...
const DUCK_ROUTE: RouteStop[] = [
    ...
    { x: 413, y: 567, holdSeconds: 0},
    { x: 413, y: 558, holdSeconds: 0},
    { x: 363, y: 558, holdSeconds: 0},
    { x: 363, y: 545, holdSeconds: 0},
    { x: 335, y: 545, holdSeconds: 0},
    { x: 335, y: 414, holdSeconds: 0},
    { x: 490, y: 414, action: "idle", holdSeconds: 10, direction: "front"},
    { x: 520, y: 414, action: "idle", holdSeconds: 10, direction: "back"},
    { x: 569, y: 414, holdSeconds: 0},
    { x: 569, y: 365, action: "idle", holdSeconds: 10, direction: "left"},
    { x: 569, y: 275, holdSeconds: 0},
    { x: 540, y: 275, action: "idle", holdSeconds: 10, direction: "left"},
    { x: 540, y: 200, action: "idle", holdSeconds: 5, direction: "front"},
    { x: 540, y: 225, action: "idle", holdSeconds: 10, direction: "right"},
    { x: 540, y: 252, holdSeconds: 0},
    { x: 439, y: 252, holdSeconds: 0},
    { x: 439, y: 270, holdSeconds: 0},
    { x: 398, y: 270, action: "idle", holdSeconds: 10, direction: "back"},
    { x: 338, y: 270, holdSeconds: 0},
    { x: 338, y: 190, holdSeconds: 0},
    { x: 314, y: 190, action: "idle", holdSeconds: 10, direction: "back"},
    { x: 333, y: 190, holdSeconds: 0},
    { x: 333, y: 282, holdSeconds: 0},
    { x: 248, y: 282, holdSeconds: 0},
    { x: 248, y: 269, action: "idle", holdSeconds: 10, direction: "back"},
    { x: 248, y: 284, holdSeconds: 0},
    { x: 184, y: 284, holdSeconds: 0},
    { x: 184, y: 238, action: "idle", holdSeconds: 10, direction: "right"},
    { x: 184, y: 158, holdSeconds: 0},
    { x: 196, y: 158, action: "idle", holdSeconds: 3, direction: "right"},
];
